...
const LoginForm = () => {
	...
	return (
		<Fragment>
			...
			>
				<Form.Item className="talent-email" label='Email Address' name='email' rules={
					[
						{
							type: 'email',
				...
				<Form.Item className="talent-password"
					label="Password"
					name="password"
					hasFeedback
					rules={
				...
				<Form.Item {...tailLayout} name="remember" valuePropName="checked" className="talent-remember">
					<Checkbox>Remember me</Checkbox>
				</Form.Item>

				<Form.Item {...tailLayout}>
					<Button type="primary" htmlType="submit" loading={loading} className="talent-login">
						Submit
        </Button>
				</Form.Item>
				<Form.Item {...tailLayout}>
					<p>
						<Link to='/talent/forget-password'>Forgot your password</Link>
					</p>
					<p>
						Not a member yet &nbsp;
							<Link to='/talent/register'>sign up</Link>
					</p>
				</Form.Item>
			</Form>
		</Fragment>
