  ...
  return (
    <Row>
              ...
              props.tags.map((tag, index) => {
                return (
                  <CheckableTag
                      ...
                      onChange={checked =>
                        props.parentHandleTagChange(checked, tag._id, tag.name, props.tagParentKey)
                      }
                    >
                      {tag.name}
                    </CheckableTag>
          ...
          <Col xs={24} sm={24} md={8} lg={8}>
            <div className="choose-role-wrapper">
              <Title level={3}>{props.inputTitle}</Title>
                  ...
                  <>
                    <Row style={{marginBottom: '5px'}} key={index}>
                      ...
                      <Col xs={21} sm={21} md={22} lg={22}> 
                        <Input value={item.tagName} key={index} disabled style={{color: 'black'}}/>
                      </Col>
                    </Row>
                  </>
                )
