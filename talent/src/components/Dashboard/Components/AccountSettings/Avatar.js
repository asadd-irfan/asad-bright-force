...
import { Typography, Row, Col, Form, Upload, message } from "antd";
import { useSelector, useDispatch } from "react-redux";
import { LoadingOutlined, PlusOutlined } from "@ant-design/icons";
import { Link } from "react-router-dom";
import { updateProfileImage } from "../../../../actions/talent";
    ...
    <Fragment>
      ...
      <Row>
        ...
        <Col xs={24} sm={24} md={12} lg={12}>
          <Form {...formItemLayout} onFinishFailed={onFinishFailed} form={form}>
            <div>
              <Row>
                ...
                <Col xs={12} sm={12} md={11} lg={11}>
                  <Paragraph>
                    Adding a picture to your name goes a long way with
                    candidates
                  </Paragraph>
                  <Paragraph>(optional)</Paragraph>
                </Col>
                <Col xs={0} sm={0} md={5} lg={7} />
              </Row>
            </div>
          </Form>
