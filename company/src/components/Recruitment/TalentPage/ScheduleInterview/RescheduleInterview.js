...
import RescheduleMeetingCalendar from "./RescheduleMeetingCalendar";
...
const ScheduleInterview = () => {
  ...
  useEffect(() => {
    if (rescheduleInterviewFlag === true) {
      setShowCalender(true);
    }
  }, [rescheduleInterviewFlag]);
        ...
        <Layout>
          ...
          <Layout>
            <Content style={{ padding: "0px 0px 0px 10px", margin: "0" }}>
              ...
              >
                <RescheduleMeetingCalendar timezoneName={currentTimezone} />
              </div>
            </Content>
          </Layout>
        </Layout>
