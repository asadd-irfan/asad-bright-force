...
function ExperienceCard() {
    const user = useSelector(state => state.talents.selectedTalent && state.talents.selectedTalent);
    const preferredRoles = useSelector(state => state.talents.selectedTalent && state.talents.selectedTalent.preferredRoles);
    ...
    }, [appConfigTechExp, preferredRoles]);
