...
import { addStaffProfile,updateProfileImage } from "../../../../../actions/talentManager";
...
const AddAccountManager = props => {
  ...
  const handleSubmit = values => {
    ...
    if (values.country || values.city) {
      ...
      const profileData = { ...values, phone: isPhone, location,role:'account-manager' };
      delete profileData.profileImage;
      dispatch(addStaffProfile(profileData)).then(()=>{
